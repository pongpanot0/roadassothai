...
const EditEltter = ({ onClose, data }) => {
  const [eletter, setEletter] = React.useState({
    id: data.eletter_id,
    Elettername: data.eletter_name,
    Elettername_en: data.eletter_name_en,
    Elettername_file: data.eletter_pdf,
  });
  ...
  const postData = async () => {
    try {
      ...
      formData.append(`eletter_id`, eletter.id); // Use unique key for each photo
